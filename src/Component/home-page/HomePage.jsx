    ...
    .then(response => {
      setLoading(true)
        ...
        const categories = response.data.map((res) => ({
            ...
            imageUrl : res.image.substring(14)
        }))
...
{/* ---------------------------------------------------------------------------------------- */}
            ...
            <div className="category-container" onClick={offPopUp}>
                {loading ? (
                  ...
                  <>
                     <div className="categories">
                     <button className="button-category" onClick={()=>navigateToProduct(optionProducts.categoryId)}><img src={`https://sivakasi-crackers.onrender.com/image/${optionProducts.image.substring(14)}`} 
                     alt="category img" className="categoryImage"></img></button>
                     <div className="category-name-container">
